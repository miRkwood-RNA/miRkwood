...
ok 'Full pipeline' [ `diff --exclude=pvalue.txt -qr $BASEDIR/output/fullpipeline1/ $BASEDIR/expected/fullpipeline1/ | wc -l` -eq 0 ]
...
ok 'Full pipeline with FilteringCDS' [ `diff --exclude=pvalue.txt -qr $BASEDIR/output/fullpipeline2/ $BASEDIR/expected/fullpipeline2/ | wc -l` -eq 0 ]
