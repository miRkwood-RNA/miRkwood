    ...
    <div id="main">
        ...
        <div id="select" >
            <div style="width: 510px"  class="forms">
                ...
                <a id="hrefposition" style="color:blue;" onclick='sortBy("position","abinitio")' >Sort by position <\/a> /  <a id="hrefquality" style="color:black;" onclick='sortBy("quality","abinitio")'  >sort by quality</a>
                </p>
        </div>
