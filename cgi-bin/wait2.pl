...
#le calcul est fini
if (-e  "/home/mohcen/arn/data/job".$now."/finished"){
	
    print $html->redirect(-uri=>'http://'.$ENV{SERVER_NAME}.'/cgi-bin/resultsWithID.pl?run_id='.$now); 
    exit; 
}
...
DATA
#<meta http-equiv="Refresh" content="5;URL=http://monprojet.com/cgi-bin/wait2.pl?jobId=.$now">
print "<meta http-equiv=\"Refresh\" content=\"6;URL=http://".$ENV{SERVER_NAME}."/cgi-bin/wait2.pl?jobId=".$now."\">";
