...
perl -I$ROOTDIR/lib $ROOTDIR/bin/mirkwood-bed.pl --varna --no-filter-multimapped --align --gff $BASEDIR/../../data/annotations/Arabidopsis_thaliana_CDS.gff --gff $BASEDIR/../../data/annotations/Arabidopsis_thaliana_tRNA_rRNA_snoRNA.gff --output $BASEDIR/output/fullpipeline-bed/ --genome $BASEDIR/../../data/genomes/Arabidopsis_thaliana.fasta $BASEDIR/data/functional_test.bed
