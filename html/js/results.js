...
{
	var allNames = new Array( "position", "strand", "mirna_sequence", "mirna_length", "list_id_with_same_mirna", "nb_reads", "reads_distribution", "quality", "length", "mfe", "mfei", "shuffles", "alignment", "precursor_name", "image" );
	var names = new Array();
