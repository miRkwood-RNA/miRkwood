...
{
	var allNames = new Array( "full_position", "position", "strand", "mirna_sequence", "mirna_length" , "nb_reads", "reads_distribution", "quality", "length", "mfe", "mfei", "shuffles", "alignment", "identifier", "image" );
	var names = new Array();
