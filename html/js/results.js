...
{
	var allNames = new Array( "full_position", "position", "strand", "mirna_sequence", "mirna_length", "quality", "length" , "mfe", "mfei", "reads", "shuffles", "alignment", "precursor_name", "image" );
	var names = new Array();
