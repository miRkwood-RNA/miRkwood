...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div id="main">
            ...
            <p>miRkwood is a software package for the discovery of microRNAs and their hairpin precursors in plant genomes.
            It combines multiple evidences to support the prediction: thermodynamical stability, conservation, miRNA:miRNA* duplex,...
            miRkwood has a user-friendly interface to navigate in the data, as
            well as many export options to conduct further analyses. </p>
            ...
            <p>
                <div class="mirkwood_button">
                    <a href="./abinitio/index.php"><b>Run mirkwood ab initio</b>,
                    for the analysis of raw genomic sequences</a>
                </div>
            </p>

            <p>
                <div class="mirkwood_button">
                    <a href="./smallRNAseq/index.php"><b>Run mirkwood small RNA-seq</b>,
                    for the analysis of deep sequencing data</a>
                </div>
            </p>
